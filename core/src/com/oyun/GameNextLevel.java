...
public class GameNextLevel implements Screen {
    ...
    public void render(float delta) {
        ...
        Preferences preferences =Gdx.app.getPreferences("prefslone");

        int scoree =preferences.getInteger("score1",100);
        int kirmiziSyc =preferences.getInteger("red1",1);
        int yesilSyc   =preferences.getInteger("green1",1);
        int sariSyc    =preferences.getInteger("yellow1",1);
        int siyahSyc   =preferences.getInteger("black1",1);
        ...
        if (seconds==0){
            ...
            ((Game)Gdx.app.getApplicationListener()).setScreen(new GameStart1());
        }
...
*/
        ...
        font.draw(batch, "Your Level1 Score :"+String.valueOf(scoree), Gdx.graphics.getWidth()/2-220, Gdx.graphics.getHeight()/2+40);
