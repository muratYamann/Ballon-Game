...
public class GameStart2 implements Screen {
    ...
    float totalTime = 1 * 10;
    float totalTimeLevel2=1*45;
    float totalTimeLevel3=1*60;
    ...
    public void show() {
        ...
        int l =preferences.getInteger("score2",100);

        int r =preferences.getInteger("red2",1);
        int g =preferences.getInteger("green2",1);
        int y =preferences.getInteger("yellow2",1);
        int b =preferences.getInteger("black2", 1);
        ...
        prefs2 =Gdx.app.getPreferences("prefslthree");
    ...
    public void render(float delta) {
            ...
            while (iter.hasNext()) {
                ...
                damla.y += 550 * Gdx.graphics.getDeltaTime();
                if (damla.y +64>550)
                    iter.remove();
        ...
        while (iter_kirmizi.hasNext()) {
            ...
            while (iter_yesil.hasNext()) {
                ...
                Y_balon.y += 400 * Gdx.graphics.getDeltaTime();
           ...
           float deltaTime = Gdx.graphics.getDeltaTime(); //You might prefer getRawDeltaTime()
            totalTimeLevel3 -= deltaTime; //if counting down
             seconds = ((int) totalTimeLevel3) % 60;
        ...
        sayfa.begin();
            ...
            sayfa.draw(background3, 0, 0, Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
